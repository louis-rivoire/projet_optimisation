 ...
 *
 */
public class BadAcquisitionPlannerMIP {
...
//			}
//		}			
		for(AcquisitionWindow w : pb.acquisitionWindows){
			if(w.satellite == satellite){
				acquisitionWindows.add(w);
			}
		}
		...
		writer.write("NacquisitionWindowsForSat = " + nAcquisitionWindows + ";");
		...
		// write the index of the corresponding acquisition
		...
		// write the priority of the acquisition
		
		writer.write("\nCandidateAcquisitionPriority = [");
		if(!acquisitionWindows.isEmpty()){
	...
	public static void main(String[] args) throws XMLStreamException, FactoryConfigurationError, IOException{
		...
		for(Satellite satellite : pb.satellites){
			String datFilename = "output_OPL/acqPlanning_"+satellite.name+".dat";
