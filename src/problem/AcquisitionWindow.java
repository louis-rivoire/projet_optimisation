...
public class AcquisitionWindow {
	...
	/** Index of this acquisition window in the list of acquisition windows of the problem */
	 ...
	 * @param volume
	 */
	public AcquisitionWindow(int idx, CandidateAcquisition candidateAcquisition, Satellite satellite,  
